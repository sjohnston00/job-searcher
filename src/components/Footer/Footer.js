    ...
    <div className={styles.main_footer}>
      ...
      <div className={styles.links}>
        ...
        <div className={styles.community}>
          <h2>Community</h2>
          <a href='https://github.com/sjohnston00/job-searcher' rel='noreferrer' target='_blank'>Developers</a>
      ...
      <div className={styles.footer_socials}>
        ...
        <div className={styles.footer_second_column}>
          ...
          <a href='https://github.com/sjohnston00' rel='noreferrer' target='blank'>
            <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href='https://www.linkedin.com/in/sam-johnston-29311b15b/' rel='noreferrer' target='blank'>
            <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
