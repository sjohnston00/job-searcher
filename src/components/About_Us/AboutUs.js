      ...
      <div className={styles.flex_container}>
        ...
        <div className={styles.services}>
          ...
          <div className={styles.services_icons}>
            ...
            <div className={styles.service_icon}>
              <svg height="24px" width="24px" viewBox="0 0 640 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={styles.service_icon}>
              <svg height="24px" width="24px" fill="currentColor" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg">
